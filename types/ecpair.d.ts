...
declare class ECPair {
     ...
     *  bchjs.ECPair.fromWIF(wif)
     * */
    static fromWIF(privateKeyWIF: any): any;
    /**
     ...
     * */
    static toLegacyAddress(ecpair: any): any;
    /**
     ...
     * */
    static toCashAddress(ecpair: any, regtest?: boolean): any;
}
